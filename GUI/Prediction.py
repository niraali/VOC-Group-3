...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.yearSoldInput.setGeometry(QtCore.QRect(20, 710, 211, 25))
        self.yearSoldInput.setObjectName("yearSoldInput")
        self.requestLabel = QtWidgets.QLabel(self.centralwidget)
        self.requestLabel.setGeometry(QtCore.QRect(340, 560, 441, 41))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.yearSoldLabel.setGeometry(QtCore.QRect(20, 670, 251, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.priceLabel.setGeometry(QtCore.QRect(20, 730, 251, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.priceInput.setGeometry(QtCore.QRect(20, 770, 211, 25))
        self.priceInput.setObjectName("priceInput")
        self.predictButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.predictButton_2.setGeometry(QtCore.QRect(20, 810, 211, 61))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.areaPrediction.setGeometry(QtCore.QRect(300, 60, 1011, 441))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.requestLabel.setText(_translate("MainWindow", "Please input information from the most recent sale "))
        self.yearSoldLabel.setText(_translate("MainWindow", "Year sold"))
        self.priceLabel.setText(_translate("MainWindow", "Price"))
        self.predictButton_2.setText(_translate("MainWindow", "Predict"))
        ...
        self.areaSummary.setText(_translate("MainWindow", "TextLabel"))
