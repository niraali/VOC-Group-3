...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.postcodeLabel.setGeometry(QtCore.QRect(20, 190, 191, 21))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label.setText(_translate("mainWindow", "Average Prices for district"))
