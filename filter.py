...
data = read_csv('ppmonth2.csv', names = ['hcode','price','date_time','post_code','h_type','Q','land_free','number','building_name','street_name','town','city','borough','county','A','AA'])
# print (data)
# print (data.head())
# Create a python list of booleans which tell us which rows match
# provided post codes
data.drop('hcode', axis=1, inplace=True)
